...
import com.nsmm.esg.scope_service.service.Scope2EmissionService;
 ...
 * @version 1.0
 */
@Tag(name = "Scope2Emission", description = "Scope 3 배출량 관리 API")
@Slf4j
@RestController
@RequestMapping("/api/v1/scope2")
@RequiredArgsConstructor
public class Scope2EmissionController {

    private final Scope2EmissionService scope2EmissionService;
    ...
    public ResponseEntity<ApiResponse<Scope2EmissionResponse>> createScope2Emission(
            @Valid @RequestBody Scope2EmissionRequest request,
        ...
        log.info("Scope 3 배출량 생성 요청: userType={}, scope2CategoryNumber={}", userType, request.getScope2CategoryNumber());
        logHeaders("Scope 3 배출량 생성", userType, headquartersId, partnerId, treePath);

        try {
            Scope2EmissionResponse response = scope2EmissionService.createScope2Emission(
    ...
    public ResponseEntity<ApiResponse<Page<Scope2EmissionResponse>>> getScope2Emissions(
        ...
        try {
            ...
            Page<Scope2EmissionResponse> response = scope2EmissionService.getScope2EmissionsByTreePath(treePath, pageable);
    ...
    public ResponseEntity<ApiResponse<Scope2EmissionResponse>> getScope2EmissionById(
        ...
        try {
            Scope2EmissionResponse response = scope2EmissionService.getScope2EmissionById(id, userId, userType, treePath);
    ...
    public ResponseEntity<ApiResponse<List<Scope2EmissionResponse>>> getScope2EmissionsByCompany(
            @RequestHeader(value = "X-USER-TYPE", required = false) String userType,
            @RequestHeader(value = "X-HEADQUARTERS-ID", required = false) String headquartersId,
            @RequestHeader(value = "X-PARTNER-ID", required = false) String partnerId,
            @RequestHeader(value = "X-TREE-PATH", required = false) String treePath) {
        ...
        try {
            List<Scope2EmissionResponse> response = scope2EmissionService.getScope2EmissionsByCompany(
    ...
    public ResponseEntity<ApiResponse<List<Scope2EmissionResponse>>> getScope2EmissionsByYear(
        ...
        try {
            List<Scope2EmissionResponse> response = scope2EmissionService.getScope2EmissionsByYear(
    ...
    @GetMapping("/emissions/category/{scope2CategoryNumber}")
    public ResponseEntity<ApiResponse<List<Scope2EmissionResponse>>> getScope2EmissionsByCategory(
            @PathVariable Integer scope2CategoryNumber,
            @RequestHeader(value = "X-USER-TYPE", required = false) String userType,
            @RequestHeader(value = "X-HEADQUARTERS-ID", required = false) String headquartersId,
            @RequestHeader(value = "X-PARTNER-ID", required = false) String partnerId,
            @RequestHeader(value = "X-TREE-PATH", required = false) String treePath) {

        log.info("카테고리별 Scope 3 배출량 조회 요청: scope2CategoryNumber={}, userType={}", scope2CategoryNumber, userType);
        logHeaders("카테고리별 Scope 3 배출량 조회", userType, headquartersId, partnerId, treePath);

        try {
            List<Scope2EmissionResponse> response = scope2EmissionService.getScope2EmissionsByCategory(
                    scope2CategoryNumber, userType, headquartersId, partnerId, treePath);
            return ResponseEntity.ok(ApiResponse.success(response,
                    String.format("카테고리 %d번 Scope 3 배출량 데이터를 조회했습니다.", scope2CategoryNumber)));
        } catch (IllegalArgumentException e) {
    ...
    public ResponseEntity<ApiResponse<List<Scope2EmissionResponse>>> getScope2EmissionsByYearAndMonth(
            @PathVariable Integer year,
        ...
        try {
            List<Scope2EmissionResponse> response = scope2EmissionService.getScope2EmissionsByYearAndMonth(
    ...
    @GetMapping("/emissions/year/{year}/month/{month}/category/{scope2CategoryNumber}")
    public ResponseEntity<ApiResponse<List<Scope2EmissionResponse>>> getScope2EmissionsByYearAndMonthAndCategory(
            @PathVariable Integer year,
            @PathVariable Integer month,
            @PathVariable Integer scope2CategoryNumber,
            @RequestHeader(value = "X-USER-TYPE", required = false) String userType,
        ...
        log.info("연도/월/카테고리별 Scope 3 배출량 조회 요청: year={}, month={}, category={}, userType={}",
                year, month, scope2CategoryNumber, userType);
        logHeaders("연도/월/카테고리별 Scope 3 배출량 조회", userType, headquartersId, partnerId, treePath);

        try {
            List<Scope2EmissionResponse> response = scope2EmissionService.getScope2EmissionsByYearAndMonthAndCategory(
                    year, month, scope2CategoryNumber, userType, headquartersId, partnerId, treePath);
            return ResponseEntity.ok(ApiResponse.success(response,
                    String.format("%d년 %d월 카테고리 %d번 배출량 데이터를 조회했습니다.", year, month, scope2CategoryNumber)));
        } catch (IllegalArgumentException e) {
    ...
    public ResponseEntity<ApiResponse<Map<Integer, BigDecimal>>> getCategorySummaryByYearAndMonth(
        ...
        try {
            Map<Integer, BigDecimal> response = scope2EmissionService.getCategorySummaryByYearAndMonth(
                    year, month, userType, headquartersId, partnerId, treePath);
            return ResponseEntity.ok(ApiResponse.success(response,
    ...
    public ResponseEntity<ApiResponse<Map<Integer, BigDecimal>>> getCategorySummaryByYear(
        ...
        try {
            Map<Integer, BigDecimal> response = scope2EmissionService.getCategorySummaryByYear(
                    year, userType, headquartersId, partnerId, treePath);
            return ResponseEntity.ok(ApiResponse.success(response,
    ...
    public ResponseEntity<ApiResponse<Scope2EmissionResponse>> updateScope2Emission(
            @PathVariable Long id,
            @Valid @RequestBody Scope2EmissionUpdateRequest request,
            @RequestHeader(value = "X-USER-TYPE", required = false) String userType,
            @RequestHeader(value = "X-HEADQUARTERS-ID", required = false) String headquartersId,
            @RequestHeader(value = "X-PARTNER-ID", required = false) String partnerId,
            @RequestHeader(value = "X-TREE-PATH", required = false) String treePath) {
        ...
        try {
            Scope2EmissionResponse response = scope2EmissionService.updateScope2Emission(
    ...
    public ResponseEntity<ApiResponse<String>> deleteScope2Emission(
            @PathVariable Long id,
            @RequestHeader(value = "X-USER-TYPE", required = false) String userType,
            @RequestHeader(value = "X-HEADQUARTERS-ID", required = false) String headquartersId,
            @RequestHeader(value = "X-PARTNER-ID", required = false) String partnerId,
        ...
        try {
            scope2EmissionService.deleteScope2Emission(id, userType, headquartersId, partnerId, treePath);
