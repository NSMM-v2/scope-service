 ...
 */
@Repository
public interface Scope1EmissionRepository extends JpaRepository<ScopeEmission, Long> {
     ...
     */
    List<ScopeEmission> findByHeadquartersIdAndScope1CategoryNumber(Long headquartersId, Integer scope1CategoryNumber);

    /**
     * 본사 ID와 연도/월/카테고리로 배출량 데이터 조회
     */
    List<ScopeEmission> findByHeadquartersIdAndReportingYearAndReportingMonthAndScope1CategoryNumber(
            Long headquartersId, Integer year, Integer month, Integer scope1CategoryNumber);
     ...
     * 본사 ID 기반 중복 데이터 검사
     */
    boolean existsByHeadquartersIdAndReportingYearAndReportingMonthAndCompanyProductCodeAndScope1CategoryNumberAndMajorCategoryAndSubcategoryAndRawMaterial(
            Long headquartersId,
     ...
     */
    List<ScopeEmission> findByHeadquartersIdAndReportingYearAndReportingMonthAndCompanyProductCodeAndScope1CategoryNumberAndMajorCategoryAndSubcategoryAndRawMaterial(
            Long headquartersId,
            Integer reportingYear,
            Integer reportingMonth,
            String companyProductCode,
     ...
     */
    List<ScopeEmission> findByPartnerIdAndTreePathStartingWithAndReportingYearAndReportingMonthAndScope1CategoryNumber(
            Long partnerId, String treePath, Integer year, Integer month, Integer scope1CategoryNumber);
     ...
     * 협력사 ID 기반 중복 데이터 검사
     */
    boolean existsByPartnerIdAndReportingYearAndReportingMonthAndCompanyProductCodeAndScope1CategoryNumberAndMajorCategoryAndSubcategoryAndRawMaterial(
            Long partnerId,
            Integer reportingYear,
            Integer reportingMonth,
            String companyProductCode,
     ...
     */
    List<ScopeEmission> findByPartnerIdAndReportingYearAndReportingMonthAndCompanyProductCodeAndScope1CategoryNumberAndMajorCategoryAndSubcategoryAndRawMaterial(
            Long partnerId,
            Integer reportingYear,
            Integer reportingMonth,
            String companyProductCode,
     ...
     * 본사 기준 연도/월별 카테고리 총계
     */
    @Query("SELECT e.scope1CategoryNumber, SUM(e.totalEmission) FROM ScopeEmission e " +
            "WHERE e.headquartersId = :headquartersId " +
            "AND e.reportingYear = :year " +
            "AND e.reportingMonth = :month " +
            "GROUP BY e.scope1CategoryNumber")
