...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Scope 2 배출량 업데이트 요청 DTO (모든 필드 부분 업데이트 지원)")
public class Scope2EmissionUpdateRequest {
    ...
    public boolean hasAnyField() {
        return majorCategory != null || subcategory != null || rawMaterial != null ||
                ...
                scope2CategoryNumber != null || scope2CategoryName != null;
    }
    ...
    public boolean hasKeyFields() {
        return reportingYear != null || reportingMonth != null || scope2CategoryNumber != null ||
